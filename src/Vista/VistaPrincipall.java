...
private void ajustarAlturasTablas() {
    ...
    mnlAyuda = new javax.swing.JMenuItem();
    mnlSalir = new javax.swing.JMenuItem();
        ...
        mnlAyuda.setText("Ver ayuda");
        mnlAyuda.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                mnlAyudaActionPerformed(evt);
            }
        });
    ...
    private void mnlAyudaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnlAyudaActionPerformed
        String ayuda = "Tico Bingo - Ayuda\n\n" +
                "- Nuevo Juego: Resetea el juego y la tómbola.\n" +
                "- Generar Cartones: Crea los cartones para vender.\n" +
                "- Vender Cartones: Registra un cartón como vendido y sus datos.\n" +
                "- Comenzar Bingo: Inicia la extracción de bolitas.\n\n" +
                "Para más detalles consulte el README del proyecto.";
        JOptionPane.showMessageDialog(this, ayuda, "Ayuda - Tico Bingo", JOptionPane.INFORMATION_MESSAGE);
    }//GEN-LAST:event_mnlAyudaActionPerformed

    private void mnlSalirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnlSalirActionPerformed
        int opt = JOptionPane.showConfirmDialog(this, "¿Desea salir de la aplicación?", "Salir", JOptionPane.YES_NO_OPTION);
    ...
    private javax.swing.JMenuItem mnlAyuda;
